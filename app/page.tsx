import { P, Text } from "@/utils/typography";
					...
					<div className="flex items-center lg:flex-row flex-col p-2 lg:py-10 pb-0">
						<div className="lg:max-w-2xl relative top-28 lg:top-1/2">
							...
							<P className="lowercase first-letter:uppercase mt-4 max-w-lg">
								...
								DRAWR, WE CAN HELP YOU TAKE CONTROL OF YOUR
								GAMING EVENT FOR COMMUNITY AND CUSTOMERS
							</P>
						</div>
...
const FrameComponent: FunctionComponent = () => {
	return (
		<div className="relative rounded-full bg-[#D1C9C933] [backdrop-filter:blur(8px)] box-border w-full h-[4.58rem] overflow-hidden [transform:_rotate(-19.95deg)] [transform-origin:0_0] opacity-[0.8] text-left text-[0.98rem] text-[#424242] font-poppins border-[2px] border-solid border-white">
			<div className="absolute top-[calc(50%_-_18.61px)] left-[12.19rem] w-[2.04rem] h-[2.04rem] overflow-hidden" />
			<div className="absolute top-[calc(50%_-_15.62px)] left-[calc(50%_-_82.82px)] font-medium [transform:_rotate(1.19deg)] [transform-origin:0_0]">{`Create a raffle event `}</div>
		</div>
	);
};
